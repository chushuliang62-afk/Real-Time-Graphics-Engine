...
// NOTE: These paths assume the working directory is set to the Debug/Release output folder
// (e.g., Coursework/x64/Debug/) where Shaders/, Textures/, and Meshes/ folders are copied.
#ifndef SHADERDIR
