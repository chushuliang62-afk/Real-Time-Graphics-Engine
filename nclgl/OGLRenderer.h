...
public:
	...
	// Public API for render passes to use
	// These were previously protected, but render passes need access to them
	void			BindShader(Shader* s);
	void			UpdateShaderMatrices();
	void			SetModelMatrix(const Matrix4& matrix) { modelMatrix = matrix; }
